...
const PredictionCaptain = (props)=>{
    ...
    return (
        <React.Fragment>
        <SideHeading>Captain Players</SideHeading>
            <div className='d-flex justify-content-center'>
                <img src="/captain-player.jpg" className="winning-card-image" />
            </div>
            {/* captain Player stuff here */}
            ...
            <div className='left-playing11'>
                ...
                {leftSideTeam.map(data => <PlayerData data={data} type={2} /> )}
                </div>
            ...
            <div className='right-playing11'>
                ...
                <hr></hr>
                 {/* right playing 11 */}
                 <div style={{marginLeft:8}}>
                 {rightSideTeam.map(data => <PlayerData data={data} type={2} /> )}
                 </div>
...
export default PredictionCaptain;